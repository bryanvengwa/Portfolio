				...
				<div className="row">
					<div className=" col-md-12 col-lg-7">
						<div className="text-container">
							<br />
							<p>
								“Hi, I’m Bryan, a Web Developer developer with
								experience in HTML, CSS, JavaScript, React.js
								and other libraries.I have a passion for
								creating visually appealing and user-friendly
								websites and am always looking for ways to
								improve my skills. I’m excited to connect with
								potential clients and employers to discuss how I
